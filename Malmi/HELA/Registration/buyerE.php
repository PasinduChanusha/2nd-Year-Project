...
if(isset($_POST['update'])){
    ...
    $query = "UPDATE buyer SET  email='$email', p_code='$p_code',a_line_1='$a_line_1',a_line_2='$a_line_2',a_line_3='$a_line_3',province='$province' WHERE b_id='$id' ";
...
<div class="form_wrapper">
        ...
        <?php 
         ...
         $name = $_SESSION["username"];
            ...
            $sql = "SELECT * FROM buyer WHERE u_name= '$name' LIMIT 1";
        ...
        ?>
            ...
            <input type="hidden" name="id" value="<?php echo $_SESSION['b_id'];?>" placeholder="id">
                                </div> 
                       ...
                       <!--  <div class="input_field"> <span><i aria-hidden="true" class="fa fa-user"></i> </span>
                        ...
                        <div class="input_field"> <span><i aria-hidden="true" class="fa fa-envelope"></i></span>
                            <input type="text" name="u_name" value="<?php echo $row['u_name'];?>" placeholder="Email" required />
                        </div>
                       ...
                       <!--  <div class="input_field"> <span><i aria-hidden="true" class="fa fa-user"></i></span>
                        ...
                        <div class="input_field"> <span><i aria-hidden="true" class="fa fa-lock"></i></span>
                            <input type="text" name="a_line_1" value="<?php echo $row['line1'];?>" placeholder="a_line_1" required />
                        </div>
                        <div class="input_field"> <span><i aria-hidden="true" class="fa fa-lock"></i></span>
                            <input type="text" name="a_line_2" value="<?php echo $row['line2'];?>" placeholder="a_line_2" required />
                        </div>

                        <div class="input_field"> <span><i aria-hidden="true" class="fa fa-lock"></i></span>
                            <input type="text" name="a_line_3" value="<?php echo $row['line3'];?>" placeholder="a_line_3" required />
                        </div>
