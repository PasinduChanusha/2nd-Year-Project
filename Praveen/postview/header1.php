...
<div class="container">
        ...
        <dev > 
        <?php include ("../php/search/inde.php"); ?>  
  ...
  <header>
      ...
      <div id="nave">
        ...
        <li><a href="">Category</a>
            <ul class="dropdown">
                <li><a href="../php/category/product.php">Home & Living</a></li>
                <li><a href="../php/category/productart.php">Arts & Crafts</a></li>
                <li><a href="#">Tools & Home</a></li>
                <li><a href="../php/category/productgardning.php">Home Gardening</a></li>
        ...
        <li><a href="indexpostview.php">Timeline</a></li>
         <li><a href="">Login</a>
            <ul class="dropdown">
