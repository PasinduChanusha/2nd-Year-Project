...
$sql=mysqli_query($connection,"SELECT password FROM buyer where password='$oldpass' AND u_name='$username'");
  echo "HELP";
...
if($sql)
{
   ...
   echo "Help";
 $con=mysqli_query($connection,"UPDATE buyer set password='$newpassword', rpassword = '$newpassword' where u_name='$username'");
